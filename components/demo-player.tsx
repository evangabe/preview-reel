      ...
      <div className="grid lg:grid-cols-[minmax(0,1.7fr)_minmax(240px,0.8fr)]">
        ...
        <aside className="border-t p-5 sm:p-6 lg:border-t-0 lg:border-l">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-2 inline-flex text-sm font-mono font-medium transition-colors hover:text-muted-foreground"
          >
            {demo.prTitle}
          </a>
          <dl className="mt-7 space-y-5">
            ...
            <div>
              ...
              <dd className="mt-1 text-sm">{formatCost(demo.modelCostUsd)}</dd>
            </div>
          </dl>
        </aside>
      </div>
